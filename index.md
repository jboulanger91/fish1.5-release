---
layout: page
title: A Functional Connectomics Resource for the Larval Zebrafish Brain
nav_title: Home
permalink: /
---
...
The dataset is editable through a collaborative proofreading tool, **CAVE** from [Dorkenwald et al., 2025](https://doi.org/10.1038/s41592-024-02426-z), allowing the community to reconstruct neurons of interest, analyze their connectivity, overlay neurotransmitter and functional information, and test circuit models. Please complete this **[form](https://forms.gle/oCB8kjXzkWYQEbYL8)** to request editing privileges. Browsing and editing the dataset requires a Google account and works best in Chrome and Firefox. 
